...
#msigdbGO = gmtPathways("~/shared_ro/pathway/c5.all.v6.1.symbols.gmt")
msigdbGO = gmtPathways("~/shared_ro/pathway/msigdb.v6.1.symbols.gmt")
head(msigdbGO,3)
...
load('~/shared_ro/pathway/xCell.data.rda')
geneSets = xCell.data$signatures

cleanNames = sub('%.*','',names(geneSets))
qList = read.table('~/shared_ro/pathway/queryList.lst',header=F,sep="\t",stringsAsFactors = F)$V1
